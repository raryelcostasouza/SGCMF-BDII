...
public class Falta  implements java.io.Serializable {
    ...
    public Falta(short idoc, Ocorrencia ocorrencia, Jogador jogador, Serializable tipo) {
        this.idoc = idoc;
        this.ocorrencia = ocorrencia;
        this.jogador = jogador;
        this.tipo = tipo;
    }
    public Falta(short idoc, Cartao cartao, Ocorrencia ocorrencia, Jogador jogador, Serializable tipo) {
       this.idoc = idoc;
       this.cartao = cartao;
       this.ocorrencia = ocorrencia;
       this.jogador = jogador;
